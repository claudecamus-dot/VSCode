...
# Adapté à VSCode (proto COMOP Node/PowerShell) — porté de VSCode1 le 2026-07-24 (veille pratiques providers, chantier 1).
_WATCHED_PREFIXES = ("comop-pptx-prototype/src/", "comop-pptx-prototype/server.js", "comop-pptx-prototype/web/", "comop-pptx-prototype/templates/")

# Signaux d'une vraie exécution de vérif dans la session (commandes Bash / skills).
_VERIF_BASH = ("smoke-test", "node --test", "npm test")
