...
- **Trier les skills BMAD** : 71 installés, 0 invocation à ce jour — décider lesquels garder, customiser ou désinstaller.
...
- **Skills projet sans usage** : `audit-technique`, `deck-design-review`, `restitution-deck-design`, `veille-agentic` — vérifier pertinence et déclencheurs.
